...
class GROCERY_IMGS():
    def __init__(self,file_dir):
        ...
        for file in os.listdir(file_dir+'Walnut/'):#AppleBraeburn
            path=file_dir+'Walnut'
        ...
        '''for file in os.listdir(file_dir+'Apricot'):
            oneclass.append(file_dir+'Apricot/'+file)
            label_oneclass.append(1)
        for file in os.listdir(file_dir+'AvocadoRipe'):
            twoclass.append(file_dir+'AvocadoRipe/'+file)
        ...
        for file in os.listdir(file_dir+'Carambula'):
            fourclass.append(file_dir+'Carambula/'+file)
